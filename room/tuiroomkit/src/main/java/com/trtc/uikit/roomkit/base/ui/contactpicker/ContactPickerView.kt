...
class ContactPickerView @JvmOverloads constructor(
    context: Context,
    ...
    private val listAdapter = ContactPickerAdapter(context) { info -> toggleSelect(info) }
    private val avatarAdapter = SelectedContactAvatarAdapter(context)
