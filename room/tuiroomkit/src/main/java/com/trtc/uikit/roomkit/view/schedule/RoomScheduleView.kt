...
class RoomScheduleView @JvmOverloads constructor(
    ...
    private val selectedTimeZone: TimeZone get() = TimeZone.getTimeZone(selectedTimeZoneId)
    ...
    private var selectAttendeeDialog: ContactPickerDialog? = null
    ...
    private fun applyEditMode() {
        ...
        cardEncrypt.visibility = GONE
        cardDevice.visibility = GONE
    ...
    private fun fillFromRoomInfo(info: RoomInfo) {
        ...
        calendar.timeInMillis = info.scheduledStartTime * 1000L
        val durationMinutes =
    ...
    private fun updateStartTimeDisplay() {
        tvStartTime.text = ScheduleDateFormatter.formatDateTime(context, calendar.timeInMillis, selectedTimeZone)
    }
    ...
    private fun showAttendeePicker() {
        dismissSelectAttendeeDialog()
        selectAttendeeDialog = ContactPickerDialog(
            context = context,
    ...
    private fun scheduleRoom() {
        ...
        val options = ScheduleRoomOptions().apply {
            ...
            scheduleStartTime = (calendar.timeInMillis / 1000).toInt()
            reminderSecondsBeforeStart = 5 * 60
            scheduleEndTime = ((calendar.timeInMillis + selectedDuration * MILLIS_PER_MINUTE) / 1000).toInt()
    ...
    private fun saveScheduledRoom() {
        ...
        val newStart = (calendar.timeInMillis / 1000).toInt()
        val newEnd = ((calendar.timeInMillis + selectedDuration * MILLIS_PER_MINUTE) / 1000).toInt()
    ...
    private fun backToHome() {
        val intent = Intent(context, RoomHomeActivity::class.java).apply {
